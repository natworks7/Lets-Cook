...
<div class="container">
    ...
    if (isset($_SESSION['id_pengguna'])) {
        ...
        $query = "SELECT r.* FROM `simpan` s JOIN `resep` r ON s.id_resep = r.id_resep WHERE s.id_pengguna = '$id_pengguna' AND s.status_simpan = 'bookmarked'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo "<p>Anda belum menyimpan resep apapun.</p>";
        }
    } else {
        echo "<p>Anda harus login untuk melihat resep yang disimpan.</p>";
    }
    ?>
</div>
